"""Para la clase CuentaBancaria, cree un método aplicar_cuota_manejo que aplique un porcentaje 
del 2% sobre el balance de la cuenta."""
...
# Ejemplo de uso del método aplicar_cuota_manejo
mi_cuenta = CuentaBancaria("9800234567", ["juan", "juliana"], 1400000.00)
