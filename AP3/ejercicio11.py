"""Para la clase CuentaBancaria, cree un método mostrar_detalles que imprima por consola los 
...
# Ejemplo de uso del método mostrar_detalles
mi_cuenta = CuentaBancaria("9800234567", ["juan", "juliana"], 1372000.00)
