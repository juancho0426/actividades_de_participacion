""" A la clase del punto anterior, defínale los siguientes métodos:Un método mostrar que imprima 
por consola las coordenadas del puntoUn método mover que cambie las coordenadas del punto
